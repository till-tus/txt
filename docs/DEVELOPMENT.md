...
The app intentionally has no network permission and no analytics. Features that read personal device data, such as calendar events and app usage, should remain optional, local, and easy to explain.
